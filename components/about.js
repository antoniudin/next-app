...
export default function About() {
    return (
        <div className={styles.content}>
            ...
            {/* </div> */}
            <h2>Anton Iudin</h2>
        <p>I am a software engineer with previous expirience in IT wich I use working on different projects.</p>
        
        <div className={styles.spacer}></div>
<p>I have an experience with .NET, C#, MVC, MS SQL, RESTfull APIs. I can work on the server side if you are dealing with Microsoft stack. But recently I am focused on front-end and deal with JavaScript and React. 
            </p>
